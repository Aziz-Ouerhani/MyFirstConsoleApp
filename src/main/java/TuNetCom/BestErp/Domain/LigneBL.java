...
public final class LigneBL {
    ...
    public LigneBL(int idLi, int numBL,  String  refProduit, String designationLi, int qteLi, double prixHT, double remise, double totHT, double tva, double totTTC) {
        this.idLi = idLi;
        this.numBL = numBL;
